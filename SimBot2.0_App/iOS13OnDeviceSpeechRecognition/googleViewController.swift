...
//
//  Created by 魏廷昇 on 2020/11/5.
//  Copyright © 2020 iowncode. All rights reserved.
//
import UIKit
import AVFoundation

class googleViewController: UIViewController, AVAudioRecorderDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    var recordBtn: UIButton!
      ...
      override func viewDidLoad() {
        ...
        recordBtn.addTarget(nil,
                          action: #selector(recordBtnAction),
                          for: .touchDown)
