//
//  waffleViewController.swift
//  iOS13OnDeviceSpeechRecognition
//
//  Created by 魏廷昇 on 2020/12/2.
...
class waffleViewController: UIViewController {

    @IBOutlet weak var history: UITextView!
    @IBOutlet weak var waffleHistory: UITextView!
    @IBOutlet weak var speak_word: UITextView!
    
    @IBOutlet weak var contrast: UITextView!
    ...
    func post(_ ret : String){
                    ...
                    let url = URL(string: "http://140.125.32.147:5001/wafflepost")!
    ...
    //                        print(responseJSON["score"]!)
                            ...
                            print(responseJSON["contrast_words"]!)
//                            var response_waffle = responseJSON["similar_words"]
                            DispatchQueue.main.async() {
                                ...
                                for num in self.brr{
                                    if(countb==0){
                                        self.waffleHistory.text=""
                                    }
                                    countb+=1
                                    print(num)
                                    self.waffleHistory.insertText(num)
                                    self.waffleHistory.insertText("\n")
                                }
                                self.crr.insert(responseJSON["contrast_words"]!,at:0)
                                var countc = 0
                                for num in self.crr{
                                    if(countc==0){
                                        self.contrast.text=""
                                    ...
                                    countc+=1
                                    print(num)
                                    self.contrast.insertText(num)
                                    self.contrast.insertText("\n")
                                }
