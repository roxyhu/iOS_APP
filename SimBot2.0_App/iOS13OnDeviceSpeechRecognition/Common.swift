...
class CommonDefine: NSObject {
    ...
    private func yunbot() -> String {
        return "021-yunbot"
    }
    private func simbot() -> String {
        return "022-simbot"
    }
    ...
    private func get_block() -> String {
        return "034-get"
    }
    private func put_block() -> String {
        return "035-put"
    }
    private func player() -> String {
        return "036-play"
    }
    ...
    func getyunbotImage() -> UIImage {
        return getImageView(yunbot())
    }
    func getsimbotImage() -> UIImage {
        return getImageView(simbot())
    }
    ...
    func getschoolImage() -> UIImage {
        return getImageView(school())
    }
    func getplayerImage() -> UIImage {
        return getImageView(player())
    }
    func getget_blockImage() -> UIImage {
        return getImageView(get_block())
    }
    func getput_blockImage() -> UIImage {
        return getImageView(put_block())
    }
}
